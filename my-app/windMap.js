...
const windLayer = new TileLayer({
  source: new XYZ({
    url: 'http://maps.openweathermap.org/maps/2.0/weather/WND/{z}/{x}/{y}?&appid=8b1f87258c77029f37948a5789d9f82a',
...
// Initialize the map
const map = new Map({
  layers: [osmLayer, windLayer], // Add both layers to the map
  target: 'map',
  view: new View({
    center: [0, 0],
    zoom: 2,
